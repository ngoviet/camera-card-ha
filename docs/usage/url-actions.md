...
| `media_player`                                                                        | :heavy_multiplication_x: | Please [request](https://github.com/ngoviet/camera-card-ha/issues) if you need this.                      |
...
| `ptz`                                                                                 | :heavy_multiplication_x: | Please [request](https://github.com/ngoviet/camera-card-ha/issues) if you need this.                      |
...
| `ptz_controls`                                                                        | :heavy_multiplication_x: | Please [request](https://github.com/ngoviet/camera-card-ha/issues) if you need this.                      |
