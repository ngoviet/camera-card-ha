    ...
    if (
      !(await this._initializer.initializeMultipleIfNecessary({
        [InitializationAspect.CAMERAS]: async () => {
          ...
          // See: https://github.com/dermotduffy/camera-card-ha/issues/1811
          // See: https://github.com/dermotduffy/camera-card-ha/issues/1769
        ...
        // See: https://github.com/dermotduffy/camera-card-ha/issues/1235
        ...(this._api.getMicrophoneManager().shouldConnectOnInitialization() && {
